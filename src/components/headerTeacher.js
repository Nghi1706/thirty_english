...
const HeaderTeacher = ({ setValue, search, handleShow, buttonName, id, idCourse }) => {
        ...
        <>
            <div className='row' style={{ padding: '20px', height: '80px', paddingRight: '0px' }}>
                ...
                <div className='col-xl-4'>
                    ...
                    {id ? (
                        <>
                            <Link to={'/HomeworksTeacher'} state={{ idCourseLevel: id }} style={{ marginRight: '20px' }}><button type="button" className='btn btn-primary'>Home works</button></Link>
                            <Link to={'/uploadvideo'} state={{ idCourse: idCourse, idCategory: id }}><button type="button" className='btn btn-primary'>Videos</button></Link>
                        </>
                    ) : (<></>)}
